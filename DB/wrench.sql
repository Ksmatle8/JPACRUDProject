...
--
-- Host: localhost    Database: wrenchdb
-- ------------------------------------------------------
...
CREATE TABLE `wrench` (
  ...
  `drawer_number` int(11) DEFAULT NULL,
...
INSERT INTO `wrench` VALUES (1,'wrench','Snap on',1,NULL,NULL,NULL,NULL,NULL),(2,'hammer','Snap on',1,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2019-07-08 14:58:06
